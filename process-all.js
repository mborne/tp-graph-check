...
for (const [username, repositoryUrl] of Object.entries(repositories)) {
    ...
    /*
     * result.branchName : on récupère l'identifiant du commit courant
     */
    {
        let commandHeadId = 'git rev-parse HEAD';
        result.headId = shell.exec(commandHeadId, { silent: true }).stdout.trim();
        console.log('HEAD : '+result.headId);
    }
